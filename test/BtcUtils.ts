...
describe("BtcUtils", function () {
  ...
  it("should parse raw btc transaction pay to address script", async () => {
    ...
    const firstQuoteHash = await BtcUtils.parseOpReturnOuput(firstTxOutputs[1].pkScript).then(ethers.toUtf8String);
    ...
    const secondQuoteHash = await BtcUtils.parseOpReturnOuput(secondTxOutputs[1].pkScript).then(ethers.toUtf8String);
